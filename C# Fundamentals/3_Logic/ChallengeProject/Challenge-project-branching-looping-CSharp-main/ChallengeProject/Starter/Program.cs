    ...
    switch (menuSelection)
    {
        ...
        case "3":
            for (int i = 0; i < maxPets; i++)
            {
                ...
                animalAge = ourAnimals[i, 2].Replace("Age: ", "");

                while (!int.TryParse(animalAge, out petAge))
                {
                    Console.WriteLine($"\nAnimal {ourAnimals[i, 0]} has an invalid or missing age.");
                ...
                ourAnimals[i, 2] = "Age: " + animalAge;
                animalPhysicalDescription = ourAnimals[i, 4].Replace("Physical description: ", "");

                while (animalPhysicalDescription == null || animalPhysicalDescription.Trim().Length == 0)
                {
                    Console.WriteLine($"\nAnimal {ourAnimals[i, 0]} has a missing physical description.");
        ...
        case "4":
            for (int i = 0; i < maxPets; i++)
            {
                ...
                animalNickname = ourAnimals[i, 3].Replace("Nickname: ", "");

                while (animalNickname == null || animalNickname.Trim().Length == 0)
                {
                    Console.WriteLine($"\nAnimal {ourAnimals[i, 0]} has a missing nickname.");
                    Console.WriteLine("Enter a nickname for this pet:");
                    readResult = Console.ReadLine();
                ...
                ourAnimals[i, 3] = "Nickname: " + animalNickname;
                animalPersonalityDescription = ourAnimals[i, 5].Replace("Personality: ", "");

                while (animalPersonalityDescription == null || animalPersonalityDescription.Trim().Length == 0)
                {
                    Console.WriteLine($"\nAnimal {ourAnimals[i, 0]} has a missing personality description.");
                    Console.WriteLine("Enter a personality description for this pet:");
                    readResult = Console.ReadLine();
            ...
            Console.WriteLine("\nNickname and personality description fields are complete for all animals.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
        case "5":
